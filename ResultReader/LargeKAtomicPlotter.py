...
def plot(tuple):
    ...
    name_file = "../thesis/images/Speedup_LargeKAtomic_" + str(tuple[0]) + "-" + str(tuple[1]) + ".pdf"
    #name_file = "Speedup_LargeKAtomic_" + str(tuple[0]) + "-" + str(tuple[1]) + ".pdf"
...
data = pd.read_csv("data_largeKAtomics.csv")
