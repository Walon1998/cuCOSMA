...
def plot(tuple):
    ...
    name_file = "../thesis/images/Speedup_square_" + str(tuple[0]) + "-" + str(tuple[1]) + ".pdf"
    # name_file = "./Speedup_square_" + str(tuple[0]) + "-" + str(tuple[1]) + ".pdf"
    ax.set(ylabel="Speedup", xlabel=r'$\omega$', title=r'M = $\omega$, N = $\omega$, K = $\omega$')
