...
nvprofs = "/home/neville/git/cucosma/Benchmarks/cosmaBenchmarks/LargeN*/nvprof*"
configs = "/home/neville/git/cucosma/Benchmarks/cosmaBenchmarks/LargeN*/config*"
...
data.to_csv("data_LargeN_flops.csv", index=False)
# cuBLAS_mean_df.to_csv("cuBLAS_mean_LargeN.csv", index=False)
# print(cuBLAS_mean_df)
