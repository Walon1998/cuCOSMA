...
nvprofs = "/home/neville/git/cucosma/Benchmarks/cosmaBenchmarks/LargeK*F*/nvprof*"
...
data.to_csv("data_LargeK_flops.csv", index=False)
# cuBLAS_mean_df.to_csv("cuBLAS_mean_LargeK.csv", index=False)
# print(cuBLAS_mean_df)
